...
def create_virtual_digest(reference_fasta, output_csv, digest_param='NlaIII'):
    ...
    -----------------------------
        ...
        : digest_param (str): the case sensitive cut enzyme
...
if __name__ == "__main__":
    create_virtual_digest(sys.argv[1], sys.stdout)